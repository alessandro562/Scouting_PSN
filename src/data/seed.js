...
export const SEED_CONTENT_VERSION = 13;
...
export const startups = [
      ...
      {
        id:"civimatica",
        awards:["Start Cup Piemonte Valle d'Aosta 2025 — Premio \"Future\"","I-Tech Innovation Program 2025-2026 (Fondazione Golinelli)","Space TO Move — acceleratore Living Lab Torino"],
        keyPeople:"Luca Ghiotto (CEO e co-fondatore)",
        sede:"Torino",
      ...
      },
      {
        id:"cyberevolution",
        toConfirm:["trl","clients"],
        clients:[{"name":"ICOS (distributore)"},{"name":"Softprom (distributore)"},{"name":"Nethesis (partner di canale)"},{"name":"EIT Manufacturing"}],
        awards:["CDP Forward Factory 2022","Industrio Ventures — accelerazione hardware","KickStart Global @Zurich","Nana Bianca"],
        certifications:["ISO 9001","ISO/IEC 27001","ISO/IEC 27017:2015","ISO/IEC 27018:2019"],
        investors:["GELLIFY","Azimut","Industrio Ventures","Mamacrowd (retail)"],
        funding:[{"tipo":"Bridge round","importo":"1,5 M€","data":"gen 2025","lead":"—","investitori":["GELLIFY","Azimut","Industrio Ventures","Investitori retail via Mamacrowd"],"nota":"Equity crowdfunding su Mamacrowd con investitori istituzionali e industriali, tramite SPV. Target massimo raggiunto."},{"tipo":"Accelerazione","importo":"n.d.","data":"2022","lead":"CDP Forward Factory","investitori":["GELLIFY (rete CDP)"]}],
        totalRaised:"≥ 1,5 M€",
        founded:"2018",
        ...
        keyPeople:"Tonino Celani (CEO e Presidente CdA), Roberto Camerinesi (CTO, inventore della tecnologia LECS)",
      },
      {
        id:"truescreen",
        toConfirm:[],
        clients:[{"name":"Tinexta InfoCert (partner distributivo)"},{"name":"DAS Assicurazioni — Gruppo Generali"},{"name":"Mia-Platform (partner tecnologico)"}],
        awards:["Top 5 startup cybersecurity al mondo — PwC Luxembourg","Top 100 startup a VivaTech Parigi (2023)","Top 100 Slush","Innovation Award 2023 — ANGI"],
        certifications:["ISO/IEC 27001","ISO 9001","Modello organizzativo D.Lgs. 231/2001"],
        investors:["Cysero EuVECA (AVM Gestioni SGR)","Kilometro Rosso","S2Capital","Growth Engine","CDP Venture Capital"],
        funding:[{"tipo":"Seed","importo":"2,4 M€","data":"set 2024","lead":"Cysero EuVECA (AVM Gestioni SGR)","investitori":["Cysero EuVECA","Kilometro Rosso","S2Capital (CVC Smeup)","Growth Engine"]},{"tipo":"Accelerazione Fin+Tech","importo":"48,5 k€","data":"2022","lead":"CDP Venture Capital","investitori":["Fin+Tech"]}],
        totalRaised:"~2,45 M€",
        dipendenti:"15",
        founded:"2022",
        ...
        valuation:"Ready to scale",
        traction:"Prodotto sul mercato · Clienti attivi · Ricavi generati",
        keyPeople:"Fabio Ugolini (CEO e co-fondatore), Giuseppe Travasoni (CTO e co-fondatore)",
      },
      {
        id:"cylock",
        toConfirm:["trl"],
        awards:["Cyber Xcelerator — CDP Venture Capital","Unicorn Kingdom: Pathfinder Award for Cyber Security","Italian Security Awards 2025 — TOP 5","ComNext (Comtel) — vincitrice (giu 2025)"],
        certifications:["ISO 9001","ISO/IEC 27001","ISO/IEC 27017","ISO/IEC 27018"],
        investors:["Scientifica Venture Capital","CDP Venture Capital SGR","Startup Wise Guys","Exor Ventures","Zest Group"],
        funding:[{"tipo":"Seed","importo":"500 k€","data":"lug 2024","lead":"Scientifica Venture Capital","investitori":["Scientifica Venture Capital"]},{"tipo":"Pre-seed / accelerazione","importo":"320 k€","data":"2022-2023","lead":"—","investitori":["CDP Venture Capital","Startup Wise Guys"]}],
        totalRaised:"> 820 k€",
        dipendenti:"3-5",
        founded:"2022",
        ...
        valuation:"Ready to scale",
        traction:"Prodotto sul mercato · Clienti attivi · Ricavi generati",
        keyPeople:"Diego Padovan (CEO e co-founder), Alessio Salzano (co-founder e CFO), Paolo Antoniani (co-founder)",
      },
      {
        id:"resilientx",
        toConfirm:["trl","clients"],
        clients:[{"name":"Armura (distributore IT)"},{"name":"CoreWin (distributore)"}],
        awards:["Myllennium Award 2025 — MyStartUp","CyberXcelerator","EPIC Program — Boston Innovation Gateway (2026)","Tech4Trust — Trust Valley"],
        investors:["Startup Wise Guys","CDP Venture Capital SGR","Trust Valley (Svizzera)","Tehnopol Startup Incubator"],
        funding:[{"tipo":"Seed","importo":"n.d.","data":"nov 2023","lead":"Startup Wise Guys","investitori":["Startup Wise Guys"]}],
        dipendenti:"11-50",
        founded:"2022",
        ...
        valuation:"Ready to scale",
        traction:"Prodotto sul mercato · Clienti attivi · Ricavi generati",
        keyPeople:"Jim Koohyar Biniyaz (CEO e Founder), Artūrs Smirnovs (CTO e co-founder), Lorenzo F. Rea (COO e co-founder)",
      },
      {
        id:"intrusa",
        toConfirm:["trl","certifications"],
        awards:["Fin+Tech — acceleratore fintech/insurtech di CDP Venture Capital"],
        certifications:["ISO 9001","ISO 27001"],
        investors:["Fin+Tech (CDP Venture Capital)"],
        funding:[{"tipo":"Accelerazione Fin+Tech","importo":"n.d.","data":"mar 2024","lead":"CDP Venture Capital","investitori":["Fin+Tech"]}],
        dipendenti:"9",
        founded:"2021",
        ...
        valuation:"Ready to scale",
        traction:"Prodotto sul mercato · Clienti attivi · Ricavi generati",
        keyPeople:"Andrea Zwirner (CEO e founder), Gigliola Sartor (co-founder), Moreno Versolatto (co-founder)",
      },
      {
        id:"aigarage",
        toConfirm:["trl","dipendenti"],
        ...
        keyPeople:"Roberto Troiani (Founder; certificazioni CISM, CISA)",
      },
      {
        id:"cyberaware",
        toConfirm:["trl","dipendenti"],
        awards:["MicroCyber4Startup 2024 — programma di incubazione"],
        dipendenti:"1",
        founded:"2025",
        ...
        keyPeople:"Domenico Campeglia (fondatore e CEO)",
      },
      {
        id:"pugliai",
        toConfirm:["trl","dipendenti"],
        awards:["ComNext by Comtel & WDA — tra le 4 startup vincitrici","Microsoft for Startups (gen 2026)","Plug and Play Summit Germania 2026"],
        investors:["Feedel Ventures (venture builder)"],
        founded:"2023",
        ...
        valuation:"Ready to scale",
        traction:"Prodotto sul mercato · Clienti attivi · Ricavi generati",
        keyPeople:"Gregor Maric (CEO e Founder, ex Senior Manager KPMG Italia)",
      },
      {
        id:"tiledesk",
        toConfirm:["trl"],
        clients:[{"name":"Trackting"},{"name":"Key-One"},{"name":"Premiata"},{"name":"Officine Carra"}],
        awards:["Startup Wise Guys — Winter Batch 2024","South Summit 2025 Madrid — top 100","AWS Activate"],
        investors:["The Techshop / Techshop Primo SGR","Startup Wise Guys","Magic Mind"],
        funding:[{"tipo":"Seed II","importo":"~45 k€","data":"nov 2024","lead":"Startup Wise Guys","investitori":["Startup Wise Guys"]},{"tipo":"Seed","importo":"600 k€","data":"mag 2022","lead":"Techshop Primo SGR","investitori":["The Techshop"]}],
        totalRaised:"~630 k€",
        founded:"2020",
        ...
        valuation:"Ready to scale",
        traction:"Prodotto sul mercato · Clienti attivi · Ricavi generati",
        keyPeople:"Andrea Sponziello (co-fondatore, CTO/Chief Scientist)",
      ...
      },
      {
        id:"ganiga",
        toConfirm:["trl"],
        clients:[{"name":"Google"},{"name":"Accenture"},{"name":"Michelin"},{"name":"Autogrill / Avolta"},{"name":"Unicoop Firenze"}],
        awards:["NVIDIA Inception Program","Google for Startups (~350 k$ in crediti)","Google AI Sustainability Award","Premio Non Sprecare — LUISS"],
        investors:["NextEnergy Capital / NextSTEP","Invitalia"],
        funding:[{"tipo":"Pre-seed (cumulato)","importo":"1,5 M€","data":"ott 2025","lead":"NextEnergy Capital / NextSTEP","investitori":["NextEnergy Capital / NextSTEP","Invitalia","business angel"]},{"tipo":"Seed","importo":"obiettivo 3 M$","data":"in raccolta (ott 2025)","lead":"—","investitori":[],"nota":"Annunciato in raccolta: nessuna conferma pubblica di chiusura al 3 ago 2026."}],
        totalRaised:"1,5 M€ (pre-seed cumulato dichiarato)",
        founded:"2021",
        ...
        valuation:"Ready to scale",
        traction:"Prodotto sul mercato · Clienti attivi · Ricavi generati",
        keyPeople:"Nicolas Lorenzo Zeoli (founder e CEO), Gabriele Cavallaro (co-founder), Gabriel Trivelli (co-founder)",
      },
      {
        id:"i2d",
        toConfirm:["trl"],
        clients:[{"name":"Esaote"},{"name":"IMS Technologies"},{"name":"Bticino"},{"name":"Giacomini"},{"name":"GTT"}],
        awards:["Global Startup Program (ICE/MAECI)","InnovIT San Francisco","SMAU","Web Summit Vancouver"],
        funding:[{"tipo":"Grant pubblico","importo":"30 k€","data":"lug 2025","lead":"Unioncamere Lombardia","investitori":["Bando SI4.0 2025"]},{"tipo":"Grant pubblico","importo":"5,1 k€","data":"mag 2024","lead":"Unioncamere Lombardia","investitori":["Bando Nuova Impresa 2024"]}],
        dipendenti:"2-10",
        founded:"2023",
        ...
        valuation:"Early traction",
        traction:"PoC completati · Prodotto sul mercato · Clienti attivi · Ricavi generati",
        keyPeople:"Tommaso Castelli (CEO)",
      },
      {
        id:"yourease",
        toConfirm:["trl"],
        clients:[{"name":"Villaggio Novoli — Firenze"},{"name":"Consorzio Fabrica"},{"name":"ASP Montedomini"},{"name":"EnEA"}],
        awards:["Italian Project Awards 2024 — vincitore","FAB50 — Premio GammaDonna 2026","Qualified Solution Provider Amazon (Alexa Smart Properties)"],
        dipendenti:"2-10",
        founded:"2024",
        ...
        valuation:"Ready to scale",
        traction:"Prodotto sul mercato · Clienti attivi · Ricavi generati",
        keyPeople:"Anna Maria Gentile (co-fondatrice e Managing Director)",
      },
      {
        id:"loki",
        clients:[{"name":"Las Rozas de Madrid (Spagna)"},{"name":"Città di Lviv (Ucraina)"}],
        awards:["IoMOBILITY Awards 2026 — Smart Road","\"50 in a Day\" OGR Torino — vincitrice","EIT Urban Mobility RAPTOR 2026","Bari Smart City Challenge"],
        funding:[{"tipo":"Grant EIT Urban Mobility","importo":"n.d.","data":"lug 2026","lead":"EIT Urban Mobility","investitori":["EIT Urban Mobility"]},{"tipo":"Incubazione","importo":"~30 k€ in servizi","data":"mag 2025","lead":"Fondazione Social Venture Giordano Dell'Amore","investitori":[]},{"tipo":"Premio","importo":"n.d.","data":"2025","lead":"Lazio Innova","investitori":[]}],
        dipendenti:"2-10",
        ...
        keyPeople:"Caterina Lia (co-founder, SW & AI), Francesco Barbieri (co-founder)",
        toConfirm:["trl","clients"],
      },
      {
        id:"nextgcloud",
        investors:["CDP Venture Capital SGR","Zest","Fondazione Compagnia di San Paolo"],
        funding:[{"tipo":"Accelerazione Magic Spectrum","importo":"n.d.","data":"2025","lead":"CDP Venture Capital SGR","investitori":["CDP Venture Capital","Zest","Fondazione Compagnia di San Paolo"]}],
        dipendenti:"2",
        ...
        keyPeople:"Dario Sabella (CEO e co-founder)",
        logo:"assets/logos/nextgcloud.png",
        certifications:["ISO 9001:2015","ISO/IEC 27001"],
        awards:["Premio America Innovazione — Camera dei Deputati","Magic Spectrum — accelerazione 5G","I3P — Politecnico di Torino"],
        clients:[{"name":"Città di Torino"},{"name":"Dipartimento per la Trasformazione Digitale"},{"name":"Quandopasso (partner)"}],
        toConfirm:["trl"],
      },
      {
        id:"beelzebub",
      ...
      {
        id:"focoos",
        clients:[{"name":"Lenovo"},{"name":"NVIDIA (partner)"},{"name":"ELT Group"}],
        funding:[{"tipo":"Seed","importo":"2,65 M€","data":"feb 2025","lead":"Galaxia (CDP Venture Capital)","investitori":["Galaxia","PiemonteNext","VC Partners SGR","Vertis SGR","Vento"]}],
        totalRaised:"2,65 M€",
        ...
        keyPeople:"Antonio Tavera (CEO e co-fondatore), Fabio Cermelli (CTO e co-fondatore), Barbara Caputo (co-fondatrice)",
        logo:"assets/logos/focoos.png",
        dipendenti:"~15",
        investors:["Galaxia (CDP Venture Capital)","PiemonteNext","VC Partners SGR","Vertis SGR","Vento"],
        awards:["I3P — incubatore Politecnico di Torino","ESA BIC Turin","I3P Start-up dell'Anno 2025","Scouting AI — ELT Group"],
        toConfirm:["trl"],
      }
    ];
